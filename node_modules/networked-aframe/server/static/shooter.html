<html>
  ...
  <body>
    ...
    ">
      ...
      <a-entity id="player" networked="template:#avatar-template;showLocalTemplate:false;" gun="bulletTemplate:#bullet-template" camera="userHeight: 1.6" spawn-in-circle="radius:3;" wasd-controls look-controls>
      </a-entity>
